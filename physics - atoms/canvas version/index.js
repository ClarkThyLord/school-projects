...
var unitsValue = {
  0: 1,
  1: 1.09361296,
  2: 3.2808388799999997,
  3: 39.370066559999997935,
  4: 100,
  5: 1000,
  6: 1000000,
  7: 1000000000,
...
window.onload = function() {
  ...
  var moveHandler = function(evt) {
    ...
    groups[movingObject["groupId"]]["line"].set({
      "x2": data["group"]["left"],
      "y2": data["group"]["top"]
    });
...
function submitProblem() {
  ...
  groups[0]["line"].set({
    "x2": giveX2FromCenter(force, angle),
    "y2": giveY2FromCenter(force, angle)
  });
  groups[0]["line"].moveTo(1000);
